...
function dl_enqueue_style() {
	...
	wp_register_style( 'my_style', get_theme_file_uri( '/assets/css/miestilo.css'), $deps, $theme_data->get( 'Version' ), 'screen' );
	wp_register_style( 'google_font', 'https://fonts.googleapis.com/css?family=Lato:300,400,700&display=swap');
