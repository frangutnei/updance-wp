<?php get_header() ?>
        ...
        <div class="aparecer container">
            <h2 class="aparecer__titulo">Aparecer en UpDance</h2>
            <p class="aparecer__parrafo">Si eres administrador de una academia de baile, o un profesor particular y te gustaría ser parte de esta comunidad de danza, te invitamos a llenar el siguiente formulario que pondremos a tu disposición.</p>
